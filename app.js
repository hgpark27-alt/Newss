...
const MOCK = [
  { id:1,  title_en:'TSMC Reports Record Q2 2025 Revenue of $20.8B, Up 36% YoY on AI Demand',
    ...
    source:'Reuters', url:'https://investor.tsmc.com/english/quarterly-results', published_at:'2025-06-18T09:00:00Z', tags:['TSMC','AI','CoWoS','실적'] },
  ...
  { id:2,  title_en:'ASML Receives Record 62 EUV Orders as AI Buildout Accelerates',
    ...
    source:'Bloomberg', url:'https://www.asml.com/en/news/press-releases.html', published_at:'2025-06-18T07:30:00Z', tags:['ASML','EUV','High-NA','수주'] },
  ...
  { id:3,  title_en:'Micron HBM3E Mass Production Exceeds Targets, Market Share Hits 38%',
    ...
    source:'Semiconductor Week', url:'https://investors.micron.com/news-releases', published_at:'2025-06-18T06:00:00Z', tags:['Micron','HBM3E','메모리','점유율'] },
  ...
  { id:4,  title_en:'Samsung Foundry Secures 2nm GAA AI Accelerator Design Win',
    ...
    source:'The Elec', url:'https://thelec.net/news/articleList.html?sc_section_code=S1N1', published_at:'2025-06-17T14:00:00Z', tags:['Samsung','파운드리','2nm','GAA'] },
  ...
  { id:5,  title_en:'US Tightens Export Controls on Advanced Semiconductor Equipment to China',
    ...
    source:'Financial Times', url:'https://www.ft.com/technology', published_at:'2025-06-17T11:00:00Z', tags:['수출통제','미중','규제','장비'] },
  ...
  { id:6,  title_en:'Intel Foundry 18A Hits Yield Milestone, Customer Tape-Outs on Track',
    ...
    source:'AnandTech', url:'https://www.intel.com/content/www/us/en/newsroom/home.html', published_at:'2025-06-17T08:30:00Z', tags:['Intel','18A','수율','파운드리'] },
  ...
  { id:7,  title_en:'NVIDIA Blackwell Ultra Production Ramps at TSMC CoWoS-S',
    ...
    source:"Tom's Hardware", url:'https://nvidianews.nvidia.com/', published_at:'2025-06-17T06:00:00Z', tags:['NVIDIA','Blackwell','TSMC','CoWoS'] },
  ...
  { id:8,  title_en:'Lam Research Q3 Revenue Beats on Memory Recovery, Guidance Raised',
    ...
    source:"Barron's", url:'https://investor.lamresearch.com/news-releases', published_at:'2025-06-16T20:00:00Z', tags:['Lam Research','메모리','장비','실적'] },
  ...
  { id:9,  title_en:"China's SMIC Claims 5nm-class Production via Multi-patterning",
    ...
    source:'SCMP', url:'https://www.scmp.com/tech/tech-trends', published_at:'2025-06-16T12:00:00Z', tags:['SMIC','중국','5nm','멀티패터닝'] },
  ...
  { id:10, title_en:'Applied Materials Launches Centris Sym3 Y Etch System for 2D Materials',
    ...
    source:'EE Times', url:'https://www.eetimes.com/semiconductor/', published_at:'2025-06-16T09:00:00Z', tags:['AMAT','식각','2D소재','장비'] },
  ...
  { id:11, title_en:'South Korea Announces ₩30T Semiconductor Cluster Investment in Yongin',
    ...
    source:'Korea Herald', url:'https://www.koreaherald.com/list.php?ct=020200000000', published_at:'2025-06-15T10:00:00Z', tags:['한국','용인','반도체클러스터','정책'] },
  ...
  { id:12, title_en:'Tokyo Electron Reports Record Quarterly Orders on AI Chip Demand',
    ...
    source:'Nikkei Asia', url:'https://asia.nikkei.com/Business/Tech/Semiconductors', published_at:'2025-06-15T07:00:00Z', tags:['TEL','도쿄일렉트론','수주','장비'] },
  ...
  { id:13, title_en:'Arm Holdings Revenue Up 34% on AI and Automotive Royalty Surge',
    ...
    source:'Financial Times', url:'https://investor.arm.com/news-and-events/press-releases', published_at:'2025-06-14T18:00:00Z', tags:['Arm','로열티','AI','자동차'] },
  ...
  { id:14, title_en:'NAND Flash Prices Set to Surge 25% in Q3 on AI Storage Demand',
    ...
    source:'TrendForce', url:'https://www.trendforce.com/research/dram.html', published_at:'2025-06-14T10:00:00Z', tags:['NAND','가격','SSD','시장전망'] },
  ...
  { id:15, title_en:'UMC and GlobalFoundries Explore Merger to Create #2 Pure-Play Foundry',
    ...
    source:'Reuters', url:'https://www.reuters.com/technology/semiconductors/', published_at:'2025-06-13T14:00:00Z', tags:['UMC','GlobalFoundries','합병','파운드리'] },
  ...
  { id:16, title_en:'ASML High-NA EUV Delivers Sub-2nm Resolution in Customer Benchmarks',
    ...
    source:'SEMI', url:'https://www.semi.org/en/news-media-press-releases', published_at:'2025-06-13T09:00:00Z', tags:['ASML','High-NA','EUV','리소그래피'] },
  ...
  { id:17, title_en:'Qualcomm Snapdragon X Takes 23% Notebook PC Share in Q1 2025',
    ...
    source:'IDC', url:'https://investor.qualcomm.com/news-events/press-releases', published_at:'2025-06-12T15:00:00Z', tags:['Qualcomm','Snapdragon','노트북','AI PC'] },
  ...
  { id:18, title_en:'Japan Chip Alliance Announces ¥3.5T Investment for Cutting-Edge Fab',
    ...
    source:'Nikkei Asia', url:'https://asia.nikkei.com/Business/Tech/Semiconductors', published_at:'2025-06-12T08:00:00Z', tags:['일본','Rapidus','투자','2nm'] },
  ...
  { id:19, title_en:'GlobalFoundries Malta Fab on Track with CHIPS Act Funding',
    ...
    source:'Semiconductor Daily', url:'https://www.gf.com/news', published_at:'2025-06-11T16:00:00Z', tags:['GlobalFoundries','CHIPS Act','미국','팹'] },
  ...
  { id:20, title_en:'KLA Introduces Process Control Suite for Gate-All-Around Transistors',
    ...
    source:'Solid State Technology', url:'https://ir.kla.com/news-releases', published_at:'2025-06-11T11:00:00Z', tags:['KLA','GAA','공정제어','검사'] },
  ...
  { id:21, title_en:'HBM Demand Forecast Raised to $65B by 2026 Amid AI Server Boom',
    ...
    source:'IDC', url:'https://www.idc.com/research/semiconductor', published_at:'2025-06-10T13:00:00Z', tags:['HBM','메모리','AI서버','시장전망'] },
  ...
  { id:22, title_en:'Infineon and STMicroelectronics Form SiC Partnership for EV Power Chips',
    ...
    source:'Automotive News', url:'https://www.infineon.com/cms/en/about-infineon/press/press-releases/', published_at:'2025-06-10T09:00:00Z', tags:['Infineon','STMicro','SiC','전기차'] },
  ...
  { id:23, title_en:'TSMC Arizona Fab 2 Begins N3 Risk Production Ahead of Schedule',
    ...
    source:'AZ Central', url:'https://www.tsmc.com/english/news-events/blog', published_at:'2025-06-09T14:00:00Z', tags:['TSMC','애리조나','N3','미국'] },
  ...
  { id:24, title_en:'AMD MI400 AI Accelerator Tapes Out at TSMC 3nm, Ships Q1 2026',
    ...
    source:"Tom's Hardware", url:'https://ir.amd.com/news-events/press-releases', published_at:'2025-06-08T11:00:00Z', tags:['AMD','MI400','AI가속기','3nm'] },
  ...
  { id:25, title_en:'Shin-Etsu and Sumco to Double 300mm Wafer Capacity by 2027',
    ...
    source:'Nikkei Asia', url:'https://asia.nikkei.com/Business/Tech/Semiconductors', published_at:'2025-06-07T08:00:00Z', tags:['신에쓰','SUMCO','웨이퍼','소재'] },
];
...
function renderRow(a) {
  ...
  return `
    <div class="news-row imp-${a.level}" data-id="${a.id}" onclick="window.open('${a.url}','_blank')">
      ...
      <div class="row-main">
        ...
        <div class="row-footer">
          ...
          ${scoreTag}
          <button class="btn-lang-row" onclick="event.stopPropagation();toggleLang(${a.id})" title="원문/번역 전환">🔄</button>
        </div>
      </div>
      <div class="row-meta">
